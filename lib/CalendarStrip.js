    ...
    return (
      <View style={styles.itemContainer}>
        ...
        >
          <View style={[
            styles.itemView,
            {backgroundColor: highlight ? highlightColor || highlightBgColor : normalBgColor}
          ]}>
            <Text style={[
              styles.itemDateText,
              {color: highlight ? hightlightTextColor : today ? highlightColor || highlightBgColor : normalTextColor}
            ]}>{solar}</Text>
            {showLunar &&
              <Text style={[
